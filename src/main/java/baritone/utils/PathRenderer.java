...
public final class PathRenderer implements IRenderer {
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        // The pathing overlay itself (current/next/in-progress path, goal, blocks to break/place,
        // guide line) is drawn by dihclient.util.DihBaritonePathRenderer on the 26.2 submit
        // pipeline; drawing it here too would double every line.
    }
