...
public final class DihContainerTarget {
    ...
    private DihContainerTarget(Kind kind, BlockPos blockPos, String entityRef, InteractionHand hand, Vec3 hitPos, Direction blockSide, boolean insideBlock) {
        this.kind = kind;
    ...
    public static DihContainerTarget forBlock(BlockPos pos) {
        if (pos == null) return null;
        return new DihContainerTarget(Kind.BLOCK, pos, "", InteractionHand.MAIN_HAND, null, null, false);
    }

    public static DihContainerTarget forBlockHit(BlockHitResult hitResult, InteractionHand hand) {
        if (hitResult == null || hitResult.getBlockPos() == null) return null;
        return new DihContainerTarget(
            Kind.BLOCK,
    ...
    public static DihContainerTarget forEntity(Entity entity, InteractionHand hand) {
        if (entity == null) return null;
        return new DihContainerTarget(Kind.ENTITY_INTERACT, null, toSpecificEntityRef(entity), hand, null, null, false);
    }

    public static DihContainerTarget forEntityAt(Entity entity, InteractionHand hand, Vec3 hitPos) {
        if (entity == null) return null;
        return new DihContainerTarget(Kind.ENTITY_INTERACT_AT, null, toSpecificEntityRef(entity), hand, hitPos, null, false);
    }

    public static DihContainerTarget forEntityRef(String entityRef) {
        if (entityRef == null || entityRef.isBlank()) return null;
        return new DihContainerTarget(Kind.ENTITY_INTERACT, null, entityRef.trim(), InteractionHand.MAIN_HAND, null, null, false);
    }
