...
public final class DihProxyGeoLookup {
    ...
    public record GeoResult(
        ...
        public static GeoResult failed(String ip, long now) {
            return new GeoResult(DihProxy.GeoStatus.FAILED, safe(ip), "", "", "", "", "", now);
        }

        public static GeoResult privateAddress(String ip, long now) {
            return new GeoResult(DihProxy.GeoStatus.PRIVATE, safe(ip), "", "", "", "", "", now);
        }
    }
    ...
    public static Map<String, GeoResult> lookupBatch(List<String> ips) {
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "Dih-ProxyGeo");
    ...
    private static GeoResult parseResult(JsonElement element, long now) {
        ...
        return new GeoResult(DihProxy.GeoStatus.RESOLVED, ip, countryCode, countryName, region, city, subdivision, now);
    }
