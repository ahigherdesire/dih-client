...
public class XCarryAction implements MacroAction {
    ...
    private void executeWithContainerOpen(Minecraft mc) {
        ...
        DihContainerTarget containerTarget = DihSharedState.get().getLastContainerTarget();
    ...
    static void sendOpenTarget(Minecraft mc, DihContainerTarget target) {
    ...
    private static boolean matchesConfiguredStorageSlot(int configuredSlot, int handlerSlotId) {
        ...
        return configuredSlot == DihInventoryHelper.FIRST_GUI_SLOT && handlerSlotId == CRAFT_RESULT_SLOT;
    }
