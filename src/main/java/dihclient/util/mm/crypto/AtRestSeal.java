...
public final class AtRestSeal {
    ...
    private static File keyFile() {
        try {
            if (DihClientAddon.FOLDER != null) return new File(DihClientAddon.FOLDER, "dih-seal.key");
        } catch (Throwable ignored) {  }
        File fallback = new File(System.getProperty("java.io.tmpdir", "."), "dihclient-seal");
        return new File(fallback, "dih-seal.key");
    }
