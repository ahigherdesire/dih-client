...
public final class DihInventoryClickHelper {
    private DihInventoryClickHelper() {
    }
    ...
    private static boolean clickNow(Minecraft mc, int handlerSlotId, int button, ContainerInput input) {
        ...
        try {
            ...
            DihCursorClickHelper.recordAfterContainerClick(mc, handler, handlerSlotId, button, input, beforeCarried, beforeSlot);
            return true;
