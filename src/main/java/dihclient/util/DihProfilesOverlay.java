...
public final class DihProfilesOverlay extends DihOverlayBase implements ProfilesPanel.Host {
    private static final String OVERLAY_ID = "dih-profiles";
    ...
    public DihProfilesOverlay(Font font) {
