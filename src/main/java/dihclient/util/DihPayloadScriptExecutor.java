...
public final class DihPayloadScriptExecutor {

    private DihPayloadScriptExecutor() {
    }
    ...
    public static ScriptResult execute(String javaSource, Context context) {
        ...
        if (!trimmed.isEmpty()) {
            DihClientMessaging.sendPrefixed("§eNote: Java scripting is disabled. Sending raw payload bytes.");
        }
    ...
    public static final class Context {
        ...
        public Identifier channelId() {
            return DihPayloadSupport.parseChannel(channel);
        }
        ...
        public String toHex(byte[] bytes) {
            return DihPayloadSupport.toHex(bytes);
        }

        public byte[] commandApiBytes(int value) {
            return DihPayloadSupport.withCommandApiValue(rawBytes, value);
        }
