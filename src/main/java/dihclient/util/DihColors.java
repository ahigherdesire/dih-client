...
public class DihColors {
    ...
    public static int accent() { return DihTheme.recolor(ACCENT, Channel.ACCENT); }
    public static int accentSoft() { return DihTheme.recolor(ACCENT_SOFT, Channel.ACCENT); }
    public static int primary() { return DihTheme.recolor(ACCENT, Channel.ACCENT); }
    public static int primaryDark() { return DihTheme.recolor(0xFF8D3838, Channel.ACCENT); }
    ...
    public static int divider() { return DihTheme.recolor(DIVIDER, Channel.OUTLINE); }
    ...
    public static int closeHover() { return DihTheme.recolor(ACCENT, Channel.ACCENT); }
    public static int closeNormal() { return DihTheme.recolor(TEXT_MUTED, Channel.TEXT); }
    public static int sectionHeaderBg() { return lessTransparent30(0x331F252A); }
    public static int sectionHeaderText() { return DihTheme.recolor(TEXT_SECONDARY, Channel.TEXT); }
    ...
    public static int dangerBorder() { return DihTheme.recolor(DANGER, Channel.DANGER); }
    public static int dangerText() { return DihTheme.recolor(DANGER, Channel.DANGER); }
    public static int successBg() { return SUCCESS_BG; }
    public static int successBorder() { return DihTheme.recolor(SUCCESS, Channel.SUCCESS); }
    public static int successText() { return DihTheme.recolor(SUCCESS, Channel.SUCCESS); }
    ...
    public static int rowSelectedBorder() { return DihTheme.recolor(0xFF66E08A, Channel.TOGGLE); }
    public static int rowSelectedAccent() { return DihTheme.recolor(0xFF40C96D, Channel.TOGGLE); }
    public static int rowSelectedText() { return DihTheme.recolor(0xFFFFF4F4, Channel.TEXT); }
    ...
    public static int textPrimary() { return DihTheme.recolor(TEXT_PRIMARY, Channel.TEXT); }
    public static int textSecondary() { return DihTheme.recolor(TEXT_SECONDARY, Channel.TEXT); }
    public static int textDim() { return DihTheme.recolor(TEXT_MUTED, Channel.TEXT); }
    public static int textMuted() { return DihTheme.recolor(TEXT_MUTED, Channel.TEXT); }
    public static int textLight() { return DihTheme.recolor(TEXT_PRIMARY, Channel.TEXT); }
    ...
    public static int slotSelectedA() { return DihTheme.recolor(ACCENT, Channel.ACCENT); }
    public static int slotSelectedB() { return DihTheme.recolor(0xFF8D3838, Channel.ACCENT); }
