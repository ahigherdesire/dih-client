...
public final class DihFreecamHighlightRenderer {
    ...
    private DihFreecamHighlightRenderer() {
    }
        ...
        LevelRenderEvents.COLLECT_SUBMITS.register(context -> {
            ...
            if (entityHit != null && entityDistSq <= blockDistSq) {
                ...
                context.submitNodeCollector().submitCustomGeometry(poseStack,
                    DihRenderTypes.storageEspFillSeeThrough(), (pose, buffer) -> fillBox(pose, buffer, box, fillColor));
                context.submitNodeCollector().submitCustomGeometry(poseStack,
                    DihRenderTypes.storageEspLinesSeeThrough(), (pose, buffer) -> renderBox(pose, buffer, box, lineColor));
                return;
            }
