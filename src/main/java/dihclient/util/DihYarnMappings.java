...
public final class DihYarnMappings {
    private static final String RESOURCE_PATH = "/dih-inspector-mappings.tsv";
    ...
    private static void ensureLoaded() {
        if (loaded) return;
        synchronized (DihYarnMappings.class) {
            if (loaded) return;
            loadMappings();
            loaded = true;
        }
    ...
    private static void loadMappings() {
        try (InputStream stream = DihYarnMappings.class.getResourceAsStream(RESOURCE_PATH)) {
