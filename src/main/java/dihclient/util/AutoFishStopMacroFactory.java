...
public final class AutoFishStopMacroFactory {
    ...
    public static DihMacro ensurePreset(Preset preset) {
    ...
    public static boolean isValidStopMacro(DihMacro macro) {
    ...
    public static boolean isGeneratedStopMacro(DihMacro macro) {
    ...
    private static DihMacro ensureMacro(String preferredName, MacroAction firstCondition) {
        DihMacroManager manager = DihMacroManager.get();
        DihMacro existing = manager.get(preferredName);
        if (existing != null) {
        ...
        DihMacro macro = new DihMacro(manager.createUniqueName(preferredName));
    ...
    private static boolean removeImmediateGeneratedAutoFishToggle(DihMacro macro) {
