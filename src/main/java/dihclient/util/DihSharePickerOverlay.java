...
public final class DihSharePickerOverlay extends DihOverlayBase {
    ...
    public DihSharePickerOverlay(Font font) {
        super("dih-share-picker", 280, 260);
        this.font = font;
        this.panelX = 140;
        this.panelY = 44;
    ...
    public void open(String title, String placeholder, Function<String, List<Row>> builder) {
        ...
        setVisible(true);
        setBounds(new DihWindowLayout(panelX, panelY, Math.max(getMinWidth(), 280), 260, true, false));
