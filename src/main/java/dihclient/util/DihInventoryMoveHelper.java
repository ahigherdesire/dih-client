...
public final class DihInventoryMoveHelper {
    ...
    public static boolean handleKeyEvent(KeyEvent input, boolean pressed) {
        ...
        if (DihOverlayManager.get().isAnyTextFieldFocused()) {
            releaseMovementKeysIfSafe();
            return false;
        }
    ...
    private static void sync(KeyMapping binding) {
        ...
        boolean physical = DihKeyMappingBridge.of(binding).dih$isActuallyDown();
