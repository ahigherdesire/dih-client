...
public final class DihFilterViewOverlay extends DihOverlayBase {
    ...
    public DihFilterViewOverlay(Font font) {
        super("dih-filter-view", 220, 200);
        this.font = font;
        this.panelX = 130;
        this.panelY = 48;
    }
    ...
    public boolean open(MmMessages.BlobOffer blob) {
        ...
        if (fv == null) { DihNotifications.show("Could not read shared filter.", 0xFFFF5B5B); return false; }
