...
public class DihCustomFilterOverlay extends DihOverlayBase {
    ...
    private final DihCustomFilterPresetOverlay presetManagerOverlay;
    ...
    public DihCustomFilterOverlay(Font textRenderer) {
        ...
        this.presetManagerOverlay = new DihCustomFilterPresetOverlay(textRenderer);
    ...
    public DihCustomFilterPresetOverlay getPresetManagerOverlay() {
        return presetManagerOverlay;
    }

    public DihPacketSelectorOverlay getPacketSelectorOverlay() {
        return packetSelectorOverlay;
    }

    @Override
    public String getOverlayId() {
        return "dih-custom-filter";
    }
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        try {
            ...
            y = drawAction(context, mouseX, mouseY, x, y, width, "Presets", () -> {
                ...
                DihOverlayManager.get().bringToFront(presetManagerOverlay);
    ...
    private int renderPacketSection(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta,
                                    ...
                                    DihModule module, CompactTextInput searchField, PacketListState listState) {
        int sectionStartY = y;
        ...
        if (filteredPackets.isEmpty()) {
            ...
            try {
                listLayout.forEachVisibleRow(filteredPackets.size(), (index, rowY) -> {
                    ...
                    String packetName = DihPacketNamer.getFriendlyName(packetClass);
    ...
    private List<Class<? extends Packet<?>>> filterPackets(List<Class<? extends Packet<?>>> packets, String query) {
        ...
        for (Class<? extends Packet<?>> packetClass : packets) {
            String name = DihPacketNamer.getFriendlyName(packetClass).toLowerCase(Locale.ROOT);
    ...
    private List<Class<? extends Packet<?>>> getCachedPackets(PacketListState state,
        ...
        sorted.sort(Comparator.comparing(DihPacketNamer::getFriendlyName, String.CASE_INSENSITIVE_ORDER));
