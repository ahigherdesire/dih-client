...
public final class DihGuiViewOverlay extends DihOverlayBase {
    ...
    public DihGuiViewOverlay(Font font) {
        super("dih-gui-view", 180, 180);
        this.font = font;
        this.panelX = 120;
        this.panelY = 50;
    }
    ...
    public boolean open(MmMessages.BlobOffer blob) {
        ...
        if (snap == null) { DihNotifications.show("Could not read shared GUI.", 0xFFFF5B5B); return false; }
    ...
    public boolean mouseClicked(double mx, double my, int button) {
        ...
        if (st != null && !st.isEmpty()) {
            ...
            if (ov != null) {
                ...
                DihOverlayManager.get().register(ov, OverlayScope.BACKGROUND_STATUS);
