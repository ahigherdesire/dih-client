...
final class MultiMacroConditions {
    ...
    private static dihclient.util.macro.WaitDurabilityAction.Comparison durCmp(MacroCondition.Cmp cmp) {
        return switch (cmp == null ? MacroCondition.Cmp.AT_LEAST : cmp) {
            case BELOW -> dihclient.util.macro.WaitDurabilityAction.Comparison.BELOW;
            case AT_MOST -> dihclient.util.macro.WaitDurabilityAction.Comparison.AT_MOST;
            case EXACT -> dihclient.util.macro.WaitDurabilityAction.Comparison.EXACT;
            case AT_LEAST -> dihclient.util.macro.WaitDurabilityAction.Comparison.AT_LEAST;
            case ABOVE -> dihclient.util.macro.WaitDurabilityAction.Comparison.ABOVE;
        };
    }
