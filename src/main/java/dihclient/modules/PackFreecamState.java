...
public final class PackFreecamState {
    ...
    public static void enable(boolean shouldReloadChunks) {
        ...
        if (dihclient.util.DihRemoteView.isActive()) {
            dihclient.util.DihRemoteView.stop(false);
        }
    ...
    private static net.minecraft.network.chat.Component speedMessage(double speed) {
        return net.minecraft.network.chat.Component.empty()
            .append(styled("[", dihclient.util.DihColors.textMuted(), false))
            .append(styled("DIH", dihclient.util.DihColors.accent(), true))
            .append(styled("] ", dihclient.util.DihColors.textMuted(), false))
            .append(styled("Freecam Speed", dihclient.util.DihColors.packetGray(), true))
            .append(styled(": ", dihclient.util.DihColors.textMuted(), false))
            .append(styled(formatSpeed(speed), dihclient.util.DihColors.packetLightYellow(), true));
    }
