...
public final class GoldenLeverModule extends Module {
    ...
    public static void tintItemStackRenderState(ItemStackRenderState output) {
        ...
        DihItemStackRenderStateAccessor accessor = (DihItemStackRenderStateAccessor) output;
        ItemStackRenderState.LayerRenderState[] layers = accessor.dih$getLayers();
        int count = Math.min(accessor.dih$getActiveLayerCount(), layers.length);
