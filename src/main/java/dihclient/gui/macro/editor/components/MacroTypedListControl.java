package dihclient.gui.macro.editor.components;
...
public final class MacroTypedListControl {
    ...
    public static void renderRow(
        ...
        int color = switch (tone == null ? CompactListRenderer.RowTone.NORMAL : tone) {
            ...
            case NORMAL -> selected ? dihclient.util.DihTheme.recolor(0xFFFFF4F4, dihclient.util.DihTheme.Channel.TEXT) : 0xFFFFFFFF;
        };
