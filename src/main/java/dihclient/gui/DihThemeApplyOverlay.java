...
public final class DihThemeApplyOverlay extends Overlay {
    ...
    public static Runnable beginJob(String title, String label) {
        ...
        mc.execute(() -> {
            ...
            shown = true;
            mc.gui.setOverlay(new DihThemeApplyOverlay());
        });
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        int border = DihTheme.recolor(0xFFB32B2B, Channel.OUTLINE);
        int textColor = DihTheme.recolor(0xFFF3ECE7, Channel.TEXT);
        ...
        dihclient.gui.vanillaui.components.ProgressBar.render(
            dihclient.gui.vanillaui.UiContexts.overlay(graphics, mc.font, mouseX, mouseY),
