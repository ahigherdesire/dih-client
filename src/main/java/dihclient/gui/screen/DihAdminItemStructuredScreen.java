...
public final class DihAdminItemStructuredScreen extends DihScreen {
    ...
    private final CompactTextInput modifier = input("dih:modifier").setText("dih:modifier");
    ...
    public DihAdminItemStructuredScreen(Screen parent, Module module, Setting<?, ?> option, Mode mode) {
    ...
    private void addRow(List<RegistryRow> rows, String filter, String id, String label) {
        String resolved = label == null || label.isBlank() ? DihRegistryLabels.identifier(id) : label;
    ...
    private void selectEntry(int index) {
        ...
        if (mode == Mode.ENCHANTMENTS) {
            ...
            modifier.setText(extract(entry, "id", "dih:modifier"));
        }
    }
    ...
    private String attributeEntry(String type, String existing) {
        ...
        String modifierId = sanitizeIdentifier(modifier.text(), "dih:modifier");
