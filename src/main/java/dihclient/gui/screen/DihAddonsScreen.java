...
public final class DihAddonsScreen extends DihScreen {
    ...
    public DihAddonsScreen(Screen parent) {
    ...
    private void renderRows(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        if (reports.isEmpty()) {
            drawText(graphics, reportsSnapshot.isEmpty() ? "No DIH addons discovered." : "No addons match the search.",
    ...
    public boolean mouseDragged(MouseButtonEvent event, double dx, double dy) {
        ...
        return super.mouseDragged(virtual, DihUiScale.toVirtual(dx), DihUiScale.toVirtual(dy));
    }
    ...
    private void copyId() {
        ...
        DihNotifications.copied("Addon ID copied.");
    }
    ...
    private void copyReport() {
        ...
        DihNotifications.copied("Addon report copied.");
    }
    ...
    private void toggleRestartDisabled() {
        ...
        DihNotifications.show(next ? "Addon disables after restart." : "Addon enables after restart.", next ? WARN : SUCCESS);
        rebuildButtons();
    }
