...
public class DihForceOpPreviewScreen extends DihScreen {
    ...
    public DihForceOpPreviewScreen(Screen parent, String[] passwords) {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        try {
            ...
            dihclient.gui.vanillaui.UiScissorStack.global().push(graphics,
                dihclient.gui.vanillaui.UiBounds.of(innerX, innerY, Math.max(0, innerW), Math.max(0, innerH)));
            try {
