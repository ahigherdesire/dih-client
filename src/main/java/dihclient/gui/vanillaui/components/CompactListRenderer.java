...
public final class CompactListRenderer {
    ...
    public static void drawRow(
        ...
        int fg = switch (tone) {
            ...
            case MISSING -> dihclient.util.DihTheme.recolor(selected ? 0xFFFFECEC : 0xFFFFAFAF, dihclient.util.DihTheme.Channel.DANGER);
            case DANGER -> dihclient.util.DihTheme.recolor(selected ? 0xFFFFEAEA : 0xFFFF8C8C, dihclient.util.DihTheme.Channel.DANGER);
            case NORMAL -> selected ? dihclient.util.DihTheme.recolor(0xFFFFF4F4, dihclient.util.DihTheme.Channel.TEXT) : THEME.color(UiTone.BODY);
        };
    ...
    public static void drawDeleteButton(
        ...
        CompactSymbolButton.renderIcon(context, CompactSymbolButton.minecraftFont(), UiBounds.of(x, y, width, height),
            dihclient.util.DihUiIcons.TRASH, hovered, true, true);
    }
