...
public class DirectCompactRow extends DirectUiContainer {
    ...
    public void render(DirectRenderContext context) {
        ...
        if (underlineOnHover) {
            ...
            context.drawContext().fill(underlineX, drawY, underlineX + underlineWidth, drawY + context.theme().scale(1), dihclient.util.DihTheme.recolor(underlineColor, dihclient.util.DihTheme.Channel.ACCENT));
        }
    }
