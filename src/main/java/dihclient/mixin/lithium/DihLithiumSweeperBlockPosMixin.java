...
public abstract class DihLithiumSweeperBlockPosMixin extends ChunkAwareBlockCollisionSweeper {
    protected DihLithiumSweeperBlockPosMixin(Level level, Entity entity, AABB box, boolean hideLastCollision) {
