...
public final class DihResourcePackTruthGuard {
    ...
    private static UrlVerdict inspectUrl(String rawUrl) {
        ...
        if (DihProtector.shouldBlockLocalUrls() && DihProtectorLocalAddressUtil.shouldBlock(host)) {
