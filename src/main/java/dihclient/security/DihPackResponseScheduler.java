...
public final class DihPackResponseScheduler {
    ...
    private DihPackResponseScheduler() {
    }
    ...
    public static long declineDelayMs() {
        long configured = Math.max(0L, dihclient.util.DihConfig.getGlobal().packResponseDelayMs);
