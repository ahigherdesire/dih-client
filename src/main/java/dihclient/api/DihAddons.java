...
import dihclient.api.event.AddonEvents;
import dihclient.api.custommenu.CustomMenuAdapter;
import dihclient.api.custommenu.CustomMenuAdapterRegistry;
import dihclient.api.hud.HudElementProvider;
import dihclient.api.hud.HudElements;
import dihclient.api.macro.MacroActionEntry;
import dihclient.api.macro.MacroActionRegistry;
...
public final class DihAddons {
    ...
    public static List<DihAddon> list() { return AddonManager.loaded(); }
    ...
    public static final class Commands {
        ...
        public void register(Command command) {
            dihclient.commands.DihCommands.registerAddonCommand(command, AddonManager.currentAddonId());
        }

        public AddonRegistrationResult registerDetailed(Command command) {
            return dihclient.commands.DihCommands.registerAddonCommandDetailed(command, AddonManager.currentAddonId());
        }
    }
